...
/** Paint/WC-style meta strip + fields, rearranged for FRP (no Type / vendor). */
export function FrpSubmittalMetaPanel({
  draft,
  draftLocked,
  packageTypeOptions,
  ...
  return (
    <section className="card stack paint-submittal-meta-card">
      ...
      <div className="paint-submittal-meta-fields-row frp-submittal-meta-fields-row">
