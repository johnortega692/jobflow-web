/** Vercel serverless — AI paint schedule import (single file, no sibling imports). */
...
async function runExtractPaint(body: PaintBody): Promise<{ items: ExtractedPaintRow[] }> {
