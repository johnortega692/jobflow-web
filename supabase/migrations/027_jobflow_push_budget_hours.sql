-- One-time push of JobFlow budget man-hours into Manpower Cal hours tracker.
...
revoke all on function public.push_budget_hours_to_manpower(uuid, numeric) from public;
grant execute on function public.push_budget_hours_to_manpower(uuid, numeric) to authenticated;
